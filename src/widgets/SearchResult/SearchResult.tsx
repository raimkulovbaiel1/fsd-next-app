      ...
      <aside className="hidden lg:block w-full lg:w-80 bg-white rounded-xl shadow p-4 h-fit mb-4 lg:mb-0">
        <form>
          ...
          <div className="mb-5">
            ...
            <select className="w-full border text-[#8B959E] text-[14px] rounded px-2 py-2">
          ...
          <div className="mb-5">
            <label className="block font-[14px] text-[#252525] mb-5"> - Страна<br />местонахождения</label>
